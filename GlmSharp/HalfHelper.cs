...
namespace GlmSharp
{
    ...
    internal static class HalfHelper
    {
        ...
        public static float HalfToSingle(Half half)
        {
            ...
            return System.BitConverter.ToSingle(System.BitConverter.GetBytes(result), 0); // TODO faster
        }
        public static Half SingleToHalf(float single)
        {
            uint value = System.BitConverter.ToUInt32(System.BitConverter.GetBytes(single), 0); // TODO faster
